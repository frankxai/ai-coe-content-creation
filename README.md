...
This repository is the implementation surface for the Starlight Intelligence Institute publishing system: living guides, field-guide ebooks, podcasts, audiobooks, operator packs, and continuously maintained search authority from one versioned research object.
...
| Claims, evidence, workflow state, approvals, metrics | Supabase/Postgres |
...
- [Edition object schema](schemas/edition-object.schema.json)
